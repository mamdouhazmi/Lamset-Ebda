...
<Image
  ...
  width={250}
  height={200}
  className="w-22 h-22 object-contain shrink-0 translate-y-2"
  priority
/>
  <span className="text-2xl lg:text-3xl font-bold text-[var(--color-light)] leading-none whitespace-nowrap">
    لمسة ابداع
  </span>
</button>
          {/* Desktop Navigation */}
